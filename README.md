...
# REINFORCE fine-tuning: actually shifts the generator's distribution toward
# higher-reward molecules, so future sampling is biased without needing large
# rejection batches every time.
